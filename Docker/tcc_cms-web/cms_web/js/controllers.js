...
/**
 * BaiduMaps - Controller for data google maps
 */
function BaiduMaps($scope) {
...
angular
    ...
    .controller('modalDemoCtrl', ["$scope", "$modal", modalDemoCtrl])
    .controller('ionSlider', ionSlider)
    .controller('wizardCtrl', ["$scope", "$rootScope", wizardCtrl])
    .controller('CalendarCtrl', ["$scope", CalendarCtrl])
    .controller('chartJsCtrl', chartJsCtrl)
    .controller('BaiduMaps', ["$scope", BaiduMaps])
    .controller('ngGridCtrl', ["$scope", ngGridCtrl])
    .controller('codeEditorCtrl', ["$scope", codeEditorCtrl])
    .controller('nestableCtrl', ["$scope", nestableCtrl])
    .controller('notifyCtrl', ["$scope", "notify", notifyCtrl])
    .controller('translateCtrl', ["$translate", "$scope",translateCtrl])
    .controller('imageCrop', ["$scope", imageCrop])
    .controller('diff',["$scope", diff])
    .controller('idleTimer', ["$scope, Idle, notify", idleTimer])
    .controller('liveFavicon', ["$scope", liveFavicon])
    .controller('formValidation', ["$scope", formValidation])
    .controller('agileBoard', ["$scope", agileBoard])
    .controller('draggablePanels', ["$scope", draggablePanels])
    .controller('chartistCtrl', chartistCtrl)
    .controller('metricsCtrl', metricsCtrl)
    .controller('sweetAlertCtrl', ["$scope", "SweetAlert",sweetAlertCtrl])
