...
(function(webim) {
	...
	Msg.Elem.Images = function(imageId) {
        ...
        Msg.Elem.Images.prototype.toHtml = function() {
                ...
                if(smallImage.width>($('.chat-history').width()*0.9-50))
                {
                    smallImage.width=($('.chat-history').width()*0.9-50);
                    return	"<img class='img-message' style=' width:"+smallImage.width+"px' src='" + smallImage.getUrl() + "#"+bigImage.getUrl()+"#"+oriImage.getUrl()+"' style='CURSOR: hand' id='"+this.getImageId()+"' bigImgUrl='"+bigImage.getUrl()+"' onclick='imageClick(this)' />";
                }else{
                    return	"<img class='img-message' src='" + smallImage.getUrl() + "#"+bigImage.getUrl()+"#"+oriImage.getUrl()+"' style='CURSOR: hand' id='"+this.getImageId()+"' bigImgUrl='"+bigImage.getUrl()+"' onclick='imageClick(this)' />";
                }
	}; 
