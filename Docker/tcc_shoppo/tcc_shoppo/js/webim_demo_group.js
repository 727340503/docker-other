...
var createGroup = function () {
    ...
    var options = {
        ...
        'Type': $('input[name="cg_type_radio"]:checked').val(), //Private/Public/ChatRoom
        'Name': $("#cg_name").val(),
        'FaceUrl': '',
    ...
    webim.getJoinedGroupListHigh(
            ...
            function (resp) {
                ...
                if (resp.GroupIdList && resp.GroupIdList.length) {
                    ...
                    if (selType == SessionType.GROUP || selToID == null) {
                        //清空聊天界面
                        ...
                        if (selSessDiv) {
                            ...
                            console.warn("不存在selSessDiv(group): selSessDivId=" + "sessDiv_" + selToID);
                        }
                        ...
                        if (selBadgeDiv) {
                            ...
                            console.warn("不存在selBadgeDiv(group): selBadgeDivId=" + "badgeDiv_" + selToID);
                        }*/
                    }
